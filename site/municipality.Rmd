...
p <- all_days_mun %>%  
  ...
  ggplot(aes(as.numeric(as.POSIXct(date)) * 1000, municipality, fill = active_per_cap_est)) + #https://stackoverflow.com/questions/38919395/plotly-r-cant-make-custom-xaxis-date-ranges-to-works
  geom_tile(
    aes(
