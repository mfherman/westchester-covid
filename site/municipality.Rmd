...
p <- all_days_mun %>%  
  ...
  ggplot(aes(as.character(date), municipality, fill = active_per_cap_limit)) + #https://stackoverflow.com/questions/38919395/plotly-r-cant-make-custom-xaxis-date-ranges-to-works
  geom_tile(
    aes(
