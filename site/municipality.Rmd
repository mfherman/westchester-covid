...
Westchester County does not currently post historical data at the municipal-level, but I have reconstructed this data using maps that have been [posted on the WestchesterGov Twitter account](https://twitter.com/westchestergov/status/1336045976981811206). The first maps that included the number of active cases per municipality were posted in early May. As such, the data I have *largely misses the first wave of the pandemic* from March and April 2020.
