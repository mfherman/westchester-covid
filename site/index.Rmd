...
pos_rate_change <- pos_rate_recent - pos_rate_last_week
```
...
<table class = "key-metric-t" style="width=300;">
  ...
  <tr>
    <td class = "t-left">New deaths</td>
    <td class = "t-right">`r comma(deaths_recent, 1)`</td>
    <td class = "t-right">`r percent_sign(deaths_change_pct, 1)`</td>
  </tr>
  <tr>
    <td class = "t-left">New cases</td>
    <td class = "t-right">`r comma(cases_recent, 1)`</td>
    <td class = "t-right">`r percent_sign(cases_change_pct, 1)`</td>
  </tr>
  <tr>
    <td class = "t-left">New tests</td>
    <td class = "t-right">`r comma(tests_recent, 1)`</td>
    <td class = "t-right">`r percent_sign(tests_change_pct, 1)`</td>
  </tr>
    <tr>
    <td class = "t-left">Positivity rate</td>
    <td class = "t-right">`r percent(pos_rate_recent, 0.1)`</td>
    <td class = "t-right">`r num_sign(pos_rate_recent, 0.1)`</td>
  </tr>
  
</table>
  </div>

  <div class = "index-column-r l-page" style = "font-size:1.4rem;line-height:1.2em;font-family:'IBM Plex Sans', sans-serif;">

In the last seven days, <span style = "color:white;background-color:steelblue;">`r comma(cases_recent, 1)` new cases</span> of Covid-19 have been reported in Westchester County. This is a <span style = "color:white;background-color:steelblue;">`r cases_change_pct_print` `r cases_change_word`</span> from the prior seven days.

There were <span style = "color:white;background-color:coral;">`r comma(deaths_recent, 1)` new deaths</span> due to Covid-19 reported in the last seven days. This is <span style = "color:white;background-color:coral;">`r abs(deaths_change)` `r deaths_change_word`</span> than in the prior seven days.
