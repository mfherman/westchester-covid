...
There were <span style = "color:white;background-color:coral;">`r comma(deaths_recent, 1)` new deaths</span> due to Covid-19 reported in the last seven days. This is <span style = "color:white;background-color:coral;">`r abs(deaths_change)` `r deaths_change_word`</span> than in the prior seven days. <span style = "color:white;background-color:coral;">`r death_per_cap`</span> Westchester residents have died from Covid-19.
  </div>
</div>
...
Cases, deaths, and tests; cluster zones; nursing home deaths
