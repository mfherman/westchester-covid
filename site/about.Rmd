...
<br>
There are a number of [methods for measuring overcrowding in housing](https://www.census.gov/programs-surveys/ahs/research/publications/Measuring_Overcrowding_in_Hsg.html). The simplest and most common methodology is to divide the number of people living in a housing unit by the number of rooms in that housing unit. If the number of occupants per room exceeds one, then that housing unit is considered overcrowded. The percentage of overcrowded households is the number of housing units with more than 1 occupant per room divided by the total number of occupied housing units.

<aside>
All rooms, not just bedrooms are counted in this measure
</aside>
