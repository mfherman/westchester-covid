...
*Most recent data: `r month_day_year(recent$date, abbr = TRUE)`*
...
*Most recent data: `r month_day_year(max(wch_cluster$date), abbr = TRUE)`*
...
*Most recent data: `r month_day_year(max(wch_nh_sum$date), abbr = TRUE)`*
