...
The timing of outbreaks in counties in the New York metro area has varied. Some counties such as Rockland, Westchester, and Nassau had particularly severe first waves in spring 2020. By contrast, other counties such as New Haven, Fairfield, Litchfield, had relatively mild first waves in the spring and more severe second waves in fall 2020. The chart below shows the variation in the number of cases per 100,000 residents from March 2020 through the present.
...
nyt_cases %>% 
  ...
  theme(
    ...
    axis.text.x = element_text(size = 6.5, color = "gray45"),
...
In October, [Governor Cuomo announced a "micro-cluster strategy"](https://www.wgrz.com/article/news/health/coronavirus/cluster-action-initiative-will-become-more-specific/71-cf1e7e41-850c-48c0-8887-82c610258d2a) in which small geographic areas are targeted with [enhanced restrictions](https://forward.ny.gov/cluster-action-initiative) on gatherings, indoor dining, and other activities. There are yellow, orange, and red zones and the determination of these clusters is based on a combination of test positivity rate, hospital admissions, and hospital capacity.

Currently, in Westchester County, there `r red_text`, `r orange_text`, and `r yellow_text`.
