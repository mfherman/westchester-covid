...
```{r county-trend-sm-mult-wide, layout="l-page", fig.retina=2, dev="ragg_png", fig.height=6, fig.width=12}
p +
...
```{r county-trend-sm-mult-long, fig.retina=2, dev="ragg_png", fig.height=12}
p +
