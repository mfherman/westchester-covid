...
ggplotly_config(to_plot) %>% 
  layout(
    ...
    annotations = list(
      x = 1, y = -0.175,
      text = "<a href='https://westchester-covid.mattherman.info/about.html#new-york-state-statewide-covid-19-testing' target='_self'>NYS Dept of Health</a>", 
      showarrow = FALSE,
...
ggplotly_config(to_plot) %>% 
  layout(
    ...
    annotations = list(
      x = 1, y = -0.175,
      text = "<a href='https://westchester-covid.mattherman.info/about.html#coronavirus-covid-19-data-in-the-united-states' target='_self'>NY Times</a>", 
      showarrow = FALSE,
      xref = "paper", yref = "paper", 
      xanchor = "right", yanchor = "auto",
      xshift = 0, yshift = 0
...
nys_cases %>% 
  ...
  datatable(
    ...
    caption = tags$caption(
      withTags(div(HTML('<a href="https://westchester-covid.mattherman.info/about.html#new-york-state-statewide-covid-19-testing">NYS Dept of Health and NY Times</a>')))
    ),
    options = list(
      dom = "t",
      deferRender = TRUE,
...
to_map %>% 
  ...
  datatable(
    ...
    caption = tags$caption(
      ...
      withTags(div(HTML('<a href="https://westchester-covid.mattherman.info/about.html#coronavirus-covid-19-data-in-the-united-states">NY Times</a>')))
    ),
    options = list(
      dom = "ft",
      deferRender = TRUE,
